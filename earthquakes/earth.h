...
public:
    ...
    // quake_app needs access for GlobeBtnPress

    void UpdateEarth(double alpha);
    
protected:
    
    //stores the earth's mesh vertices
    ...
    std::vector<Point3> morph_verts;
    std::vector<Vector3> morph_norms;
